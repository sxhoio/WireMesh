...
func (a *App) Router() http.Handler {
	...
	mux.HandleFunc("GET /api/v1/nodes/{id}/peer-config", a.withUser(RoleOperator, a.nodePeerConfig))
	mux.HandleFunc("GET /api/v1/nodes/{id}/client-config", a.withUser(RoleOperator, a.nodeClientConfig))
