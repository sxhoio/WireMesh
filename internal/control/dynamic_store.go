...
func (s *SwitchableStore) ListProjects(tenant string) ([]Project, error) {
...
func (s *SwitchableStore) ListNetworks(tenant, project string) ([]Network, error) {
...
func (s *SwitchableStore) ListNodes(tenant, network string) ([]Node, error) {
	return s.store().ListNodes(tenant, network)
}
func (s *SwitchableStore) ListNodeRefs(tenant, network string) ([]Node, error) {
...
func (s *SwitchableStore) ListCommandsPage(tenant, node string, limit, offset int, errorsOnly bool) ([]AgentCommand, error) {
...
func (s *SwitchableStore) HasNodeAuditAction(tenant, nodeID string, actions ...string) (bool, error) {
	return s.store().HasNodeAuditAction(tenant, nodeID, actions...)
}
