      ...
      <div class="min-h-0 flex-1 overflow-x-auto p-6">
        <table class="w-full min-w-[640px] text-left text-sm">
          ...
          <tbody>
            ...
            <tr v-if="!mesh.scopedTempPeers.length"><td colspan="6" class="py-12 text-center"><p class="text-sm text-slate-400">没有临时对等端数据</p><p class="mt-1 text-xs text-slate-600">页面不会生成或保存临时对等端本地记录。</p></td></tr>
          </tbody>
        </table>
      </div>
    </div>
